...
class Book {
     ...
     */
    int currentBorrowerId = NO_PATRON;
     ...
     */
    void returnBook() {
        currentBorrowerId = NO_PATRON;
    }


    /**
     * The comic value getter.
