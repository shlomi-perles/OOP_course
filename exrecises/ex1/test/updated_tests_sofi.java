...
class tester_updated4 {
    public static void main(String[] args) {
        ...
        System.out.println(book1.stringRepresentation().equals("[book1,author1,2001,7]"));

        System.out.println(book1.getLiteraryValue() == 3 + 3 + 1);
        ...
        System.out.println("0.2:" + (patron1.getBookScore(book1) == 3 * 3 + 5 * 3 + 1 * 1));
        ...
        // valid
        System.out.println("22: " + (lib.borrowBook(book2ID, patron1ID1)));
        System.out.println("23: " + (!lib.borrowBook(book3ID, patron1ID1))); // too many books for one patron
        System.out.println("24: " + (!lib.borrowBook(book2ID, patron1ID1))); // the book is taken
        lib.returnBook(book1ID);
        System.out.println("25: " + (lib.borrowBook(book3ID, patron1ID1)));
        ...
        System.out.println("27.1 " + lib.borrowBook(book1ID, patron2ID1));
